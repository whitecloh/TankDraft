Shader "SLVR/UI/SoftGlowOverlay"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f input) : SV_Target
            {
                ...
                half phase = (_Phase + _Time.y * _Speed * _AnimationEnabled) * 6.28318530718h;
                half pulse = lerp(1.0h - _PulseAmount, 1.0h, sin(phase) * 0.5h + 0.5h);
                fixed4 color = fixed4(input.color.rgb * _GlowColor.rgb * (_Intensity * pulse), source.a * _GlowColor.a);
